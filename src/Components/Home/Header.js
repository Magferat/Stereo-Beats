...
const Header = () => {
    return (
        <div className="header-bg text-white">
            <div className=" text-end py-5 px-4 ms-auto mt-lg-5">
                <p className='p-5 mt-lg-5 fw-bold display-1'>Get royalty free music <br />
                    and SFX for your videos</p>

                <p className='fw-bold display-6 px-5 mb-5'>
                ...
                <div className='flex-row flex-sm-column'>
                    ...
                    <HashLink className="link  fw-bold fs-2 text-white"
                        to="/home#price"><button type="button" className="btn btn-outline-info text-white fw-bold border-2 rounded-3 fs-2 px-5 py-3 mx-5">Pricing</button></HashLink>
